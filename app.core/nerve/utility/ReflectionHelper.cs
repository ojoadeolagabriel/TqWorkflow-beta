            ...
            foreach (PropertyInfo property in propertyInfo)
            {
                ...
                if (property.CanWrite)
                {
                    ...
                    else
                    {
                        ...
                        {
                            property.SetValue(objTarget, DeepCopyUsingReflection(objPropertyValue), null);
                        }
                    }
                }
            }
		...
		#region YieldReaderWriterLockSlim
			...
			internal struct YieldReaderWriterLockSlim
			{
				#region Consts
					...
					private const Int32 _writeLockValue = ((Int32)1) << _writeBitShift;
					private const Int32 _writeUnlockValue = -_writeLockValue;
					private const Int32 _upgradeLockValue = ((Int32)1) << _upgradeBitShift;
					private const Int32 _upgradeUnlockValue = -_upgradeLockValue;
					private const Int32 _allReadsValue = _upgradeLockValue-1;
					private const Int32 _someExclusiveLockValue = _writeLockValue | _upgradeLockValue;
					private const Int32 _someExclusiveUnlockValue = -_someExclusiveLockValue;
				#endregion

				#region Fields
					private Int32 _lockValue;
				#endregion
				...
				#region EnterReadLock
					...
					public void EnterReadLock()
					{
						while(true)
						{
							Int32 result = Interlocked.Increment(ref _lockValue);
				...
				#region EnterUpgradeableLock
					...
					public void EnterUpgradeableLock()
					{
						while(true)
						{
							Int32 result = Interlocked.Add(ref _lockValue, _upgradeLockValue);
				...
				#region UpgradeToWriteLock
					...
					{
						Int32 result = Interlocked.Add(ref _lockValue, _writeLockValue);
