    ...
    $.each(bundles.Routes, function () {
        ...
        if (route.BundleState == "Active") {
            ...
            msg = "<div class=\"btn-group\" role=\"group\" aria-label=\"...\">" +
                      "<button data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Tooltip on bottom\" id=\"activity\" name=\"activity\"  type=\"button\" onclick='" + command + "(\"" + route.GuidData + "\")' class=\"btn btn-default\">" + statusMsg + "</button>" +
...
$(document).ready(function () {
    ...
    $('#frmSearchBtn').click(function (ev) {
        var pmUrl = 'http://127.0.0.1:7098/api/v2/app.management.api/status.search/' + $('#frmSearch').val();
